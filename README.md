...
1. Add new expenses with amount and category
2. Store data persistently using JSON
3. View all recorded expenses
4. Group and analyze spending by category
5. Simple interactive command-line interface
